...
--changeset rgrzegorczyk:create_locations_table runOnChange:false failOnError:true
--comment CCreate the LOCATIONS table to hold address information for company departments. DEPARTMENTS has a foreign key to this table.

...
--changeset rgrzegorczyk:populate_v1 runOnChange:false stripComments:true 
...
--rollback TRUNCATE TABLE jobs;
--rollback TRUNCATE TABLE departments;
--rollback TRUNCATE TABLE locations;
--rollback TRUNCATE TABLE countries;
--rollback TRUNCATE TABLE regions;

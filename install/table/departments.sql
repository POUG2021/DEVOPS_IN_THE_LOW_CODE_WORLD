...
--changeset rgrzegorczyk:create_departments_table runOnChange:false failOnError:true
--comment reate the DEPARTMENTS table to hold company department information. EMPLOYEES and JOB_HISTORY have a foreign key to this table.
